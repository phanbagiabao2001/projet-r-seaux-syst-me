...
/*
 * ARM Cortex Mx Processor NVIC ISERx (Interrupt set-enable register)  register Address
 */
...
/*
 * ARM Cortex Mx Processor NVIC ICERx (Interrupt clear-enable register)  register Address
 */
...
/*
 * ARM Cortex Mx Priority register Address calculation
 */
#define NVIC_PR_BASE_ADDR			(volatile uint32_t*)0xE000400
...
#define SRAM1_BASEADDR			0x20000000U //watch in memory map (112kb)
#define SRAM2_BASEADDR			0x2001C000U	//base add of sram2 appears after sram1, so it is 112*1024 => hex or watch in page 62
#define ROM_BASEADDR			0x1FFF0000U //system memory
#define SRAM 					SRAM1_BASEADDR

//AHBx and APBx bus Peripheral base addresses
#define PERIPH_BASEADDR			0x40000000U
#define APB1PERPH_BASEADDR		PERIPH_BASEADDR
#define APB2PERPH_BASEADDR		0x40010000U
#define AHB1PERPH_BASEADDR		0x40020000U
#define AHB2PERPH_BASEADDR		0x50000000U

//base addresses of peripherals which are hanging on AHP1 bus
#define GPIOA_BASEADDR 			(AHB1PERPH_BASEADDR + 0x0000)	//it is hanging on AHB1 bus, so we take it as a base and add its offset
#define GPIOB_BASEADDR 			(AHB1PERPH_BASEADDR + 0x0400)
#define GPIOC_BASEADDR 			(AHB1PERPH_BASEADDR + 0x0800)
#define GPIOD_BASEADDR 			(AHB1PERPH_BASEADDR + 0x0C00)
#define GPIOE_BASEADDR 			(AHB1PERPH_BASEADDR + 0x1000)
#define GPIOF_BASEADDR 			(AHB1PERPH_BASEADDR + 0x1400)
#define GPIOG_BASEADDR 			(AHB1PERPH_BASEADDR + 0x1800)
#define GPIOH_BASEADDR 			(AHB1PERPH_BASEADDR + 0x1C00)
#define RCC_BASEADDR			(AHB1PERPH_BASEADDR + 0x3800)

//base addresses of peripherals which are hanging on APB1 bus
#define I2C1_BASEADDR			(APB1PERPH_BASEADDR + 0x5400)
#define I2C2_BASEADDR			(APB1PERPH_BASEADDR + 0x5800)
#define I2C3_BASEADDR			(APB1PERPH_BASEADDR + 0x5C00)
...
//GPIO_RegDef_t *GPIOA = (GPIO_RegDef_t*)0x40020000;
//GPIO_RegDef_t *GPIOA = GPIOA;
...
#define USART6_PLCK_DI()			( RCC->APB2ENR &= ~(1<<6) )
...
#define I2C1_REG_RESET()			do {( RCC->APB1RSTR |= (1<<21) );		( RCC->APB1RSTR &= ~(1<<12) );} while(0)
#define I2C2_REG_RESET()			do {( RCC->APB1RSTR |= (1<<22) );		( RCC->APB1RSTR &= ~(1<<22) );} while(0)
#define I2C3_REG_RESET()			do {( RCC->APB1RSTR |= (1<<23) );		( RCC->APB1RSTR &= ~(1<<23) );} while(0)

/*
 * IRQ number of STM32F446RET
 */
